...
class Tello:
    ...
    def __init__(self,
        ...
        # Run state receiver on background
    ...
    def get_states(self):
        """This runs on background to receive the state of Tello"""
        while True:
            try:
    ...
    def get_pitch(self):
        if self.response_state == 'ok':
            ...
            try:
                ...
                print("Exception in pitch occurred")
                return 0
    ...
    def get_roll(self):
        if self.response_state == 'ok':
            ...
            try:
                ...
                print("Exception in roll occurred")
                return 0
    ...
    def get_yaw(self):
        if self.response_state == 'ok':
            ...
            try:
                ...
                print(f"Exception in velocity in x occurred: {e}")
                return 0
    ...
    def get_vgy(self):
        if self.response_state == 'ok':
            ...
            try:
                ...
                print("Exception in velocity in y occurred")
                return 0
    ...
    @accepts(command=str)
    def send_command_with_return(self, command) -> [str, bool]:
